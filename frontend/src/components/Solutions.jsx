    ...
    <section className="bg-[#E6F4EA] py-20">
      ...
      <div className="flex flex-wrap justify-center gap-8 max-w-7xl mx-auto">
        <div className="bg-green-900 text-white rounded-2xl p-8 text-center w-72">
          ...
          <img src="/icons/first.png" alt="Surprise Bags" className="mx-auto w-20 h-20 mb-6" />
          <p className="text-lg mt-2">Unlock revenue from surplus food.</p>
        </div>

        <div className="bg-green-900 text-white rounded-2xl p-8 text-center w-72">
          <h3 className="text-2xl font-bold">COMMUNITY AWARENESS</h3>
          <img src="/icons/second.png" alt="Community Awareness" className="mx-auto w-20 h-20 mb-6" />
        ...
        <div className="bg-green-900 text-white rounded-2xl p-8 text-center w-72">
          ...
          <img src="/icons/third.png" alt="Collaborations" className="mx-auto w-20 h-20 mb-6" />
          <p className="text-lg mt-2">
        ...
        <div className="bg-green-900 text-white rounded-2xl p-8 text-center w-72">
          ...
          <img src="/icons/forth.png" alt="Smart Food Logistics" className="mx-auto w-20 h-20 mb-6" />
          <p className="text-lg mt-2">
