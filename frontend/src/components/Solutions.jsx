    ...
    <section className="bg-[#E6F4EA] py-20 px-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        ...
        <div className="bg-green-900 text-white rounded-2xl p-6 md:p-8 text-center">
          ...
          <img src="src/assets/icons/first.png" alt="Surprise Bags" className="mx-auto w-16 md:w-20 h-16 md:h-20 mb-4" />
          <p className="text-base md:text-lg mt-2">Unlock revenue from surplus food.</p>
        </div>

        {/* Community Awareness */}
        <div className="bg-green-900 text-white rounded-2xl p-6 md:p-8 text-center">
          <h3 className="text-2xl font-bold">COMMUNITY AWARENESS</h3>
          <img src="src/assets/icons/second.png" alt="Community Awareness" className="mx-auto w-16 md:w-20 h-16 md:h-20 mb-4" />
        ...
        <div className="bg-green-900 text-white rounded-2xl p-6 md:p-8 text-center">
          ...
          <img src="src/assets/icons/third.png" alt="Collaborations" className="mx-auto w-16 md:w-20 h-16 md:h-20 mb-4" />
          <p className="text-base md:text-lg mt-2">
        ...
        <div className="bg-green-900 text-white rounded-2xl p-6 md:p-8 text-center">
          ...
          <img src="src/assets/icons/forth.png" alt="Smart Food Logistics" className="mx-auto w-16 md:w-20 h-16 md:h-20 mb-4" />
          <p className="text-base md:text-lg mt-2">
